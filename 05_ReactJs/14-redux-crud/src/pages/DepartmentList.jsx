                ...
                data.item.map((v,i) => {
                  return (
                    <tr key={v.deptno}>
                      ...
                      <td>{v.loc}</td>
                      <td>
                        <button type='button' data-deptno={v.deptno} onClick={onEditClick}>
                          수정하기
                        </button>
                      </td>
                      <td>
                        <button type='button' data-deptno={v.deptno} data-dname={v.dname} onClick={onDeleteClick}>
                          삭제하기
                        </button>
                      </td>
                    </tr>
          ...
          {data && (
            <Pagenation>
              {data.pagenation.prevGroupLastPage > 0 ? (
                <li>
                  <NavLink to={`/query=${query}&rows=${rows}&page=${data.pagenation.prevGroupLastPage}`}>&laquo;</NavLink>
                </li>
              ) : (
              ...
              {data.pagenation.nextGroupLastPage > 0 ? (
                <li>
...
//                       li.push(
//                         <li key={i}>
//                           <NavLink to={`/?query=${query}&rows=${rows}&page=${i}`}>
//                             {i}
//                           </NavLink>
//                         </li>
//                       );
