...
// import { postItem } from '../slice/DepartmentSlice';
...
//           current.dname,
//           2,
//           '학과이름은 최소 2글자 이상 입력해야 합니다.'
//         );
//         RegexHelper.maxLength(
//           current.dname,
//           20,
//           '학과이름은 최대 20글자 까지 입력 가능합니다.'
//         );
...
//           current.loc,
//           2,
//           '학과위치는 최소 2글자 이상 입력해야 합니다.'
//         );
//         RegexHelper.maxLength(
//           current.loc,
//           20,
//           '학과위치는 최대 20글자 까지 입력 가능합니다.'
//         );
//       } catch (e) {
...
//       // 리덕스를 통한 데이터 저장 요청 -> 처리가 완료 된 후 목록 페이지로 강제 이한다.
//       dispatch(
//         postItem({
