...
// const MyPropTypeSub = (props) => {
  // 비구조 문법을 통해 변수 속성 값을 변수로 선언
  // const {name, age, hobby} = props;
const MyPropTypeSub = ({name, age, hobby}) => {
  return (
    <div>
      <h3>MyPropsTypeSub</h3>
      <p>
